export class RenderComics {
    ...
    renderComics(comics) {
        ...
        if (pageCount)
            pageCount.textContent = (_a = comics.pageCount) !== null && _a !== void 0 ? _a : "número de páginas não disponível";
        ...
        if (containerCharacters)
            containerCharacters.innerHTML = ((_d = (_c = comics.characters) === null || _c === void 0 ? void 0 : _c.items) === null || _d === void 0 ? void 0 : _d.length) > 0
        ...
        if (containerSeries)
            containerSeries.innerHTML = ((_f = (_e = comics.series) === null || _e === void 0 ? void 0 : _e.items) === null || _f === void 0 ? void 0 : _f.length) > 0
