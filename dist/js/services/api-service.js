...
export class MarvelApiService {
  _transformResults(results, tipo) {
    return results.map((item) => {
      ...
      return {
        ...
        thumbnail: {
          path:
            ((_a = item.thumbnail) === null || _a === void 0
              ? void 0
              : _a.path) || null,
          extension:
            ((_b = item.thumbnail) === null || _b === void 0
              ? void 0
              : _b.extension) || null,
        },
      };
  ...
  fetchContent(tipo_1, termo_1, offset_1, limit_1) {
    return __awaiter(
      ...
      arguments,
      void 0,
      function* (tipo, termo, offset, limit, orderBy = "") {
        ...
        console.log(
          `[MarvelApiService] Cache MISS. Fetching from network: ${url}`,
        );
        try {
