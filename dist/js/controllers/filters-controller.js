...
export class FiltersController {
    ...
    adicionarEventos() {
        ...
        btnBuscar === null || btnBuscar === void 0 ? void 0 : btnBuscar.addEventListener('click', () => {
            if (inputBusca) {
    ...
    atualizarConteudo(tipo_1, termo_1) {
        return __awaiter(this, arguments, void 0, function* (tipo, termo, limpar = false) {
            ...
            try {
                ...
                const total = yield consumeAPI(tipo, termo, this.offset, this.resultadosPorPagina, '', this.renderer);
